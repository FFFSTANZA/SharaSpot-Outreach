...
Upload and manage email attachments stored in Cloudflare R2.
...
In your `POST /attachments/upload` request, send files as multipart form data. Files are uploaded to Cloudflare R2 and metadata is returned.
...
In your `DELETE /attachments/delete` request, remove a file from Cloudflare R2.

|Field|Description|
|---|---|
|url|Cloudflare R2 URL of the file to delete|
