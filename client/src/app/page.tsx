...
const features = [
  { icon: Users, title: "Multi-Sender Rotation", desc: "Rotate across multiple email accounts automatically. Distribute volume, avoid rate limits, and scale your outreach without risking any single account.", color: "from-blue-500 to-blue-600" },
  { icon: Gauge, title: "Human-Like Scheduling", desc: "Random delays between emails that mimic real sending patterns. No robotic fixed intervals that trigger spam filters.", color: "from-blue-600 to-blue-800" },
  { icon: Flame, title: "Automatic Warmup", desc: "New senders ramp from 20 to 500 emails/day over 14 days, building inbox reputation safely. Skip it for accounts with existing history.", color: "from-blue-500 to-blue-700" },
  { icon: Eye, title: "Open & Click Tracking", desc: "See who opens your emails and clicks your links. Real-time metrics with per-recipient and per-link breakdowns.", color: "from-blue-500 to-blue-600" },
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative overflow-hidden pt-10 pb-16 md:pt-16 md:pb-28 lg:pt-20 lg:pb-36">
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:flex lg:items-center lg:gap-16">
          <div className="lg:flex-1 text-center lg:text-left" style={{ animation: "fadeInUp 0.8s ease-out" }}>
            <div className="inline-flex items-center gap-2 rounded-full bg-blue-50 border border-blue-200 px-4 py-1.5 text-sm font-semibold text-blue-700 mb-6">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-extrabold text-gray-900 leading-[1.1] tracking-tighter">
              ...
              <span className="bg-gradient-to-r from-blue-600 to-blue-600 bg-clip-text text-transparent">most powerful channel</span>
            </h1>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center lg:justify-start">
              <Button className="w-full sm:w-auto px-8 py-3.5 text-sm rounded-full shadow-lg shadow-blue-600/25" onClick={() => router.push("/login")}>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4 justify-center lg:justify-start text-sm text-gray-600">
              <span className="flex items-center gap-1.5"><Shield className="h-3.5 w-3.5 text-blue-600" /> AES-256 encrypted</span>
              <span className="h-1 w-1 rounded-full bg-gray-400 hidden sm:block" />
              <span className="flex items-center gap-1.5"><Zap className="h-3.5 w-3.5 text-blue-600" /> $20/month</span>
              <span className="h-1 w-1 rounded-full bg-gray-400 hidden sm:block" />
              <span className="flex items-center gap-1.5"><Clock className="h-3.5 w-3.5 text-blue-600" /> 2 min setup</span>
            </div>
          </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-xs text-gray-500">
                    ...
                    <div className="flex gap-1">
                      <span className="rounded-full bg-blue-50 text-blue-700 px-2 py-0.5 font-medium">you@company.com</span>
                      <span className="rounded-full bg-blue-50 text-blue-700 px-2 py-0.5 font-medium">+2 more</span>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 text-xs text-gray-500">
                  ...
                  <div className="text-[13px] text-gray-600 leading-relaxed space-y-2 py-1">
                    <p>Hi <span className="bg-blue-100 text-blue-700 px-1 rounded font-mono text-[11px] font-semibold">{"{{name}}"}</span>,</p>
                    <p>I noticed <span className="bg-blue-100 text-blue-700 px-1 rounded font-mono text-[11px] font-semibold">{"{{company}}"}</span> is growing and I'd love to explore how we can work together...</p>
                  </div>
                  <div className="flex items-center gap-2 pt-2">
                    <div className="flex items-center gap-1.5 rounded-full bg-blue-50 px-2.5 py-1 text-[10px] font-semibold text-blue-700 border border-blue-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
            {features.map((f, i) => (
              <AnimatedSection key={i} delay={i * 80} className="h-full">
                <div className="group h-full rounded-2xl border border-gray-200 bg-white p-5 md:p-6 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-50 transition-all duration-300 flex flex-col relative overflow-hidden">
      ...
      <section id="use-cases" className="py-16 sm:py-24 md:py-32 bg-gray-50">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="text-center mb-12 md:mb-20">
            <p className="text-sm font-bold text-blue-600 uppercase tracking-wider mb-3">Use Cases</p>
      ...
      <section id="how-it-works" className="py-16 sm:py-24 md:py-32">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6 relative">
            <div className="hidden md:block absolute top-12 left-[20%] right-[20%] h-px bg-gradient-to-r from-transparent via-blue-200/60 to-transparent" />
            {steps.map((s, i) => (
              <AnimatedSection key={i} delay={i * 120} className="text-center relative group">
                <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-white border-2 border-blue-200 shadow-sm relative z-10 group-hover:shadow-lg group-hover:border-blue-300 transition-all duration-300">
                  <s.icon className="h-6 w-6 text-blue-600" strokeWidth={1.8} />
                </div>
                <span className="inline-block text-[10px] font-bold text-white bg-blue-600 rounded-full px-2.5 py-0.5 uppercase tracking-widest mb-3">Step {s.num}</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-0">
            {[
              ...
              <div key={i} className={`text-center ${i > 0 ? "md:border-l md:border-white/10" : ""} py-2`}>
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-400 to-blue-400 bg-clip-text text-transparent">
      ...
      <section className="py-16 sm:py-24 md:py-32">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="relative rounded-2xl sm:rounded-3xl bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800 px-6 py-12 sm:px-10 sm:py-16 md:px-16 md:py-20 text-center overflow-hidden">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-gradient-to-b from-blue-600/20 to-transparent rounded-full blur-3xl" />
            <div className="absolute bottom-0 right-0 w-64 h-64 bg-blue-500/10 rounded-full blur-3xl" />

            <div className="relative">
              <div className="inline-flex items-center gap-2 rounded-full bg-white/10 backdrop-blur-sm px-4 py-1.5 text-sm font-semibold text-blue-300 mb-6 border border-white/10">
                <Rocket className="h-3.5 w-3.5" />
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-white mb-4 tracking-tight leading-tight">
                ...
                <span className="bg-gradient-to-r from-blue-400 to-blue-400 bg-clip-text text-transparent">the right people?</span>
              </h2>
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
                <Button className="w-full sm:w-auto px-8 py-3.5 text-sm rounded-full shadow-lg shadow-blue-600/30" onClick={() => router.push("/login")}>
