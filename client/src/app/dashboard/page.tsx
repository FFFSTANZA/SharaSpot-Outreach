...
function AnalyticsWidget({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl bg-white border border-gray-100/80 p-5 transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:border-gray-200/80">
      <div className="flex items-start justify-between relative z-10 mb-5">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex flex-col">
            <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest leading-none mb-1">{label}</span>
      ...
      <div className="flex items-end justify-between relative z-10">
        <div className="space-y-1.5">
          ...
          {subValue && (
            <p className="text-[11px] font-medium text-gray-500 leading-tight flex items-center gap-1.5">
                ...
                <div className="px-5 md:px-8 mt-4 mb-5 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] font-semibold text-gray-500 uppercase tracking-widest leading-none mt-1">
