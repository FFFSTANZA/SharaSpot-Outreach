    ...
    <div className="flex-1 flex flex-col min-h-0 bg-white">
      ...
      <div className="flex items-center gap-4 px-6 py-3 border-b border-border-light bg-background/50 sticky top-0 z-10 backdrop-blur-sm">
        ...
        <div className="w-48 shrink-0 min-w-0">
          <span className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Recipient Pool</span>
        </div>
        <div className="flex-1 min-w-0">
          <span className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Context / Subject</span>
        </div>
        <div className="w-24 shrink-0">
          <span className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Lifecycle</span>
        </div>
        <div className="w-20 shrink-0 text-right">
          <span className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Timestamp</span>
        </div>
      </div>
