...
export default function TermsPage() {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: "You may use SharaSpot to send professional outreach emails related to job seeking, networking, and career development. You must comply with all applicable email laws including CAN-SPAM, GDPR, and your local regulations.",
    },
    {
      icon: Ban,
      title: "Prohibited Use",
      content: "You may not use SharaSpot for spam, phishing, harassment, or any illegal activity. You may not send emails to purchased lists, scraped addresses without consent, or recipients who have opted out. Abuse will result in account termination.",
    },
    {
      icon: AlertTriangle,
      title: "Disclaimer",
