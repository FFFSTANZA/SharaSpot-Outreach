        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-gray-600">support@folonite.in</p>
            </div>
          </a>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-gray-600">Get help & connect with us</p>
            </div>
          </a>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-lg border border-gray-200 bg-gray-50 px-3.5 py-3 text-sm text-gray-900 outline-none placeholder:text-gray-300 transition-all focus:border-brand/40 focus:ring-2 focus:ring-brand/10 resize-none"
              />
            </div>
            <button
              type="submit"
