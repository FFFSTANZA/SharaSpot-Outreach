      ...
      <main className="mx-auto max-w-3xl px-4 sm:px-6 py-10 sm:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          ...
          <a
            ...
            className="flex items-center gap-4 rounded-xl border border-gray-100 p-5 hover:border-gray-200 hover:shadow-sm transition-all group"
          >
            <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
