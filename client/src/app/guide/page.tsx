...
export default function GuidePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <div className="relative overflow-hidden py-16 md:py-24 bg-gradient-to-b from-emerald-50/60 to-white">
        ...
        <div className="relative mx-auto max-w-3xl px-4 sm:px-6 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight leading-tight">
            ...
            <span className="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">land more replies</span>
          </h1>
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 py-12 md:py-16 space-y-16">
        ...
        <Section id="throttling">
          ...
          <p className="text-sm text-gray-500 mb-6 leading-relaxed">
            SharaSpot enforces multiple layers of rate limiting to protect your sender accounts from suspension.
          </p>
            ...
            <div className="divide-y divide-gray-50">
              {warmupSchedule.map((w) => (
                <div key={w.day} className="flex flex-col sm:flex-row sm:items-center sm:justify-between px-4 sm:px-5 py-3 text-sm gap-1 sm:gap-0">
                  ...
                  <span className="text-gray-500 text-xs sm:text-sm sm:text-right sm:flex-1 sm:ml-4">{w.note}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-2 mb-6">
            {[
              ...
              <div key={layer.label} className="flex items-start gap-3 p-3 rounded-lg bg-gradient-to-b from-white to-gray-50/50 border border-gray-100 hover:border-gray-200 transition-all">
                <layer.icon className="h-4 w-4 text-amber-500 shrink-0 mt-0.5" strokeWidth={1.8} />
                <div>
                  <p className="text-xs font-semibold text-gray-900">{layer.label}</p>
                  <p className="text-[11px] text-gray-500 mt-0.5 leading-relaxed">{layer.desc}</p>
                </div>
              </div>
            ))}
          </div>
                ...
                {[
                  ...
                  <div key={s.step} className="flex items-center gap-3 px-5 py-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[11px] text-gray-500">{s.wait}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-xl border border-gray-100 overflow-hidden">
              ...
              <div className="p-4 font-mono text-xs text-gray-600 bg-gray-50/50">
                <p className="text-gray-500">email,name,company,role</p>
