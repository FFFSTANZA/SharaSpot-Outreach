  ...
  return (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <g transform="translate(16,16)">
        ...
        <path d="M-5.5,0 L10,0" stroke="rgba(255,255,255,0.2)" strokeWidth="0.8"/>
...
export function Logo({ size = "md", variant = "dark", showText = true, className }: LogoProps) {
  const sizes = {
    ...
    md: { box: "h-10 w-10 rounded-xl", text: "text-[22px]", svg: "h-5 w-5" },
    lg: { box: "h-12 w-12 rounded-xl", text: "text-3xl", svg: "h-6 w-6" },
