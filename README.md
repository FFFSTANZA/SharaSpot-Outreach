<p align="center">
  <img src="client/public/favicon.svg" alt="SharaSpot" width="80" height="80" />
</p>
...
- Cloudflare R2 account (for attachment storage)

### 1. Clone and Install

```bash
git clone https://github.com/fffstanza/SharaSpot.git
```
